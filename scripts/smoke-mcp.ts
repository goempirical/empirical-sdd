...
try {
  ...
  for (const args of [[], ["help"], ["--help"], ["-h"]]) {
    ...
    if (
      !help.stdout.includes("empirical v0.26.1")
  ...
  console.log("Bundled 0.26 OAuth-first Init, tracker, uninstall, receipt, routing, YOLO, worktree, CLI, and MCP smoke passed.");
} finally {
  await client.close();
